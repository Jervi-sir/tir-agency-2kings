$(document).ready(function() {
    ...
    if (document.getElementById("map")) {
        ...
        var location = document.getElementById("lieu_lat_long").value;
        var ar_location = location.split(', '); // split string on comma space


        var lat = ar_location[0];
        var long = ar_location[1];
        ...
        function init() {
            ...
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(35.291960, -1.124787),
                map: map,
                title: 'Snazzy!'
            });
        }
