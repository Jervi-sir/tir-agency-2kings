                ...
                <div class="flt-dtls-box rt-mb-30">
                    ...
                    <div class="flight-list-box rt-mb-30">
                        <div class="top-content d-flex flex-md-row flex-column justify-content-lg-between">
                            ...
                            <img src="{{ asset('storage/' . $voiture->image) }}" alt="image voiture" id="mainImage" width="100%" class="rt-border-primary2">
                            <div class="mt-2">
                                @if($voiture->images)
                                <img class="img-thumbnail" src="{{ asset('storage/' . $voiture->image) }}"  width="50" >
