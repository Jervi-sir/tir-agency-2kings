            ...
            <div class="col-lg-7">
                <div class="rt-duel-slider-main rt-mb-30">
                    <div class="single-main rtbgprefix-cover" >
                        <img class="single-main rtbgprefix-cover" src="{{ asset('storage/' . $hotel->image) }}" id="mainImage">
                        <div class="mt-2">
                            @if($hotel->images)
                            <img class="img-thumbnail" src="{{ asset('storage/' . $hotel->image) }}"  width="50" >
                                                        ...
                                                        <div class="col-lg-12 col-md-6">
                                                            <ul class="rt-list d-flex flex-lg-row flex-column justify-content-md-between box-style__1 rt-light-bg rt-mb-10">
                                                                ...
                                                                <li class="rt-pt-8 col-3">
                                                                    <span class="d-block">
                                                                        <img src="{{asset('storage/' .  $product->image)}}" alt="hotel iamge" draggable="false" width="100%">
