    ...
    <div id="full-stars-example-two">
        <div class="rating-group">
            ...
            <label aria-label="1 star" class="rating__label" for="rating3-1">
                <a href="{{ route('hotels.index', ['sort' => request('sort') ,
                                                    'etoiles' => 1,
...
<div class="container-flex row" style="padding: 0;">
    ...
    <a class="sort-size col-8" href="{{ route('hotels.index', ['sort'     => 'asc' ,
    ...
    <a class="sort-size col-8" href="{{ route('hotels.index', ['sort'     => 'desc' ,
                                        'etoiles'   => request('etoiles'),
                                        'min_prix'  =>request('min_prix'),
                                        'max_prix'  =>request('max_prix')])}}">
    descending</a>
    ...
    <div class="hotel-inner-content row">
        <div class="hotel-thumb col-md-4 mb-4 mb-md-0">
            <div  class="mb-0">
                ...
                <img src="{{ asset('storage/' . $product->image) }}" class="hotel-bg rtbgprefix-cover">
        ...
        <div class="hotel-text col-lg-3 px-0">
             <div class="right text-left text-md-right mt-md-0">
                    ...
                    <span class="d-block mt-2 col-12" style="color: rgba(255, 167, 0, 0.79);font-weight: 600;font-size: 21px;">
                        {{ getPriceHelper($product->chambres->min('prix')) }}</span>
                    <span class="d-block text-left col-12 mt-1 mb-5">pour une nuit </span>
