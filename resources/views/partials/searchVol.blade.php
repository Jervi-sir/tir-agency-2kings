<form action="{{ route('vols.searchVol')}}">
    ...
    <div class="rt-input-group">
        <div class="single-input  col-rt-in-3">
            <input type="text" class="form-control  has-icon" placeholder="Lieu Départ" name="search_vol_depart" id="speechToText" value="{{ request()->search_vol_depart ?? '' }}">
            <i class="fa fa-microphone" onclick="record()" aria-hidden="true" style="top: 34%;position: absolute;right: 9%;font-size: 1.4em;"></i>
        </div>
        <div class="single-input  col-rt-in-3">
            <input type="text" class="form-control  has-icon" placeholder="Lieu Arrivée"  id="speechToText2" name="search_vol_arrivee" value="{{ request()->search_vol_arrivee ?? '' }}">
        ...
        <!-- /.single-input -->
        <div class="single-input  col-rt-in-3">
            <input type="text" id="demo-3_1" class="form-control has-icon" placeholder="Date de départ" name="date_depart" value="{{ request()->date_depart ?? '' }}">
            <span class="input-iconbadge"><i class="icofont-ui-calendar"></i></span>
        </div><!-- /.single-input -->
        <div class="single-input  col-rt-in-3">
            <input type="text" id="demo-3_2" class="form-control rt-date-picker has-icon" placeholder="Date de retour" name="date_retour" value="{{ request()->date_retour ?? '' }}">
            <span class="input-iconbadge"><i class="icofont-ui-calendar"></i></span>
        </div><!-- /.single-input -->
