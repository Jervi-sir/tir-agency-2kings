                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td class="table-action">
                                                ...
                                                <button type="button" class="btn btn-md btn-danger d-flex justify-content-center align-items-center" data-toggle="modal" data-target="#modelOf{{ (string)$chambre->id }}" data-placement="top" title="supprimer">
