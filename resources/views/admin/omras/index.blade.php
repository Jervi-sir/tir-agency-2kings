                                ...
                                <table class="table table-bordered table-striped" style="overflow-x: scroll;display: block; ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td ><img src="{{asset('storage/' .$omra->image) }}" width="50"></td>
                                            </td>
                                            <td>{{ $omra->prix }}</td> 
                                            <td>{{ $omra->lieu }}</td>
                                            <td>{{ $omra->email }}</td>
                                            ...
                                            <td class="table-action">
                                                ...
                                                <button type="button" class="btn btn-md btn-danger d-flex justify-content-center align-items-center" data-toggle="modal tooltip" data-target="#modelOf{{ (string)$omra->id }}"  data-placement="top" title="supprimer">
