...
<head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{ secure_secure_asset('storage/' . \App\Agence::first()->logo) }}">
    <!-- Meta Description -->
    ...
    <script src="{{ secure_secure_asset('js/vue.min.js') }}"></script>
    <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
@yield('extra-script')
        <!--CSS=========================================================== -->
        <link rel="stylesheet" href="{{ secure_secure_asset('css/linearicons.css') }}">
        <link rel="stylesheet" href="{{ secure_secure_asset('css/font-awesome.min.css') }}">
        ...
        <link rel="stylesheet" href="{{ secure_secure_asset('css/jquery-ui.css') }}">             
        ...
        <link rel="stylesheet" href="{{ secure_secure_asset('css/owl.carousel.css') }}">              
        <link rel="stylesheet" href="{{ secure_secure_asset('css/main.css') }}">
        <link rel="stylesheet" href="{{ secure_secure_asset('css/additional.css') }}">
        <link rel="stylesheet" href="{{ secure_secure_asset('css/checkbox.css') }}">
        <link rel="stylesheet" href="{{ secure_secure_asset('css/lightpick.css') }}">
...
-->
        ...
        <div class="container main-menu">
            <div class="row align-items-center justify-content-between d-flex">
                <div id="logo">
                    <div class="row">
                        <div class="col-5">
                            <a href="index.html"><img src="{{ secure_secure_asset('storage/' . \App\Agence::first()->logo) }}" alt="" title="" /></a>
                        </div>
                        ...
                        <ul class="nav-menu">
                            ...
                            <li class="mx-3">
                                <a href="{{ route('omra.index') }}">
                                    <img style="transform: translate(0px,-4px);width: 25px;" src="{{ secure_secure_asset('img/crescent-moon-on-top-of-minaret.png') }}" >
    ...
    <script src="{{ secure_secure_asset('js/vendor/jquery-2.2.4.min.js') }}"></script>
    <script src="{{ secure_secure_asset('js/popper.min.js') }}"></script>
    <script src="{{ secure_secure_asset('js/vendor/bootstrap.min.js') }}"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
    <script src="{{ secure_secure_asset('js/jquery-ui.js') }}"></script>
    <script src="{{ secure_secure_asset('js/easing.min.js') }}"></script>
    <script src="{{ secure_secure_asset('js/hoverIntent.js') }}"></script>
    <script src="{{ secure_secure_asset('js/superfish.min.js') }}"></script>
    <script src="{{ secure_secure_asset('js/jquery.ajaxchimp.min.js') }}"></script>
    ...
    <script src="{{ secure_secure_asset('js/mail-script.js') }}"></script>
    <script src="{{ secure_secure_asset('js/main.js') }}"></script>
    <script src="{{ secure_secure_asset('js/additional.js') }}"></script>
    <script async src="https://buttons.github.io/buttons.js"></script>
    <script src="{{ secure_secure_asset('js/moment.min.js') }}"></script>
    <script src="{{ secure_secure_asset('js/lightpick.js') }}"></script>
    <script src="{{ secure_secure_asset('js/demo.js') }}"></script>
