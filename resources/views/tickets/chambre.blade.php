...
@section('titleSite')
    <title>{{ \App\Agence::first()->nom_agence}} - Hôtel > ticket</title>
@endsection
        ...
        <div class="flt-dtls-box mx-auto mt-5" style="width: 75%;">
            ...
            <ul class="rt-list d-flex flex-lg-row flex-column justify-content-md-between box-style__1 rt-light-bg rt-mb-10 row">
                ...
                <li class="rt-pt-8 col-md-4">
                    <span class="d-block"><img src="{{ secure_asset( $chambre->image) }}" alt="chambre->hotel iamge" draggable="false" id="mainImage">
                ...
                <li class="rt-pt-8 col-md-4">
                    ...
                    <p class="f-size-13 text-333 line-height-20"><span></span>
                        ...
                        @else
                        <i class="fa fa-times-circle"></i> pas d'annulation
                        @endif
    ...
    <div class="row" id="ticket-print">
        <div class="cardWrap">
            <div class="card cardLeft">
                <div class="h1"> {{ $chambre->hotel->titre }} <span class="right">hôtel</span></div>
                <div class="title1">
                    <span>Nom du Client</span>
                    <div class="h2">{{$order->nom}} {{$order->Prénom}}</div>
                </div>
                <div class="name1">
                    <span>Chambre réservée</span>
                    <div class="row">
